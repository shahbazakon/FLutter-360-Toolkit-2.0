...
class _FluidSliderState extends State<FluidSlider> with SingleTickerProviderStateMixin {
  ...
  TextStyle _currentValTextStyle(BuildContext context) {
    final TextStyle defaultStyle =
        widget.showDecimalValue ? Theme.of(context).textTheme.titleMedium!.copyWith(fontWeight: FontWeight.bold) : Theme.of(context).textTheme.displayLarge!.copyWith(fontWeight: FontWeight.bold);
